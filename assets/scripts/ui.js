...
<div class="selo">⭐ Melhor Vaga</div>
...
<p class="empresa">🏢 ${melhorVaga.empresa}</p>
...
<div
class="progress-ring"
style="--progress:${melhorVaga.porcentagem}; --cor:${cor};">
...
${
    melhorVaga.faltantes.length
        ? melhorVaga.faltantes
              ...
              .join("")
        : `<span class="chip completo">Nenhuma 🎉</span>`
}
...
<p class="empresa">🏢 ${relatorio.empresa}</p>
...
<div
class="progress-ring"
style="--progress:${relatorio.porcentagem}; --cor:${cor};">
...
export function mostrarRecomendacao(recomendacao) {
    ...
    area.innerHTML = "<h3>📚 Plano de Estudos</h3>";
